...
<body class="bg-gray-100 min-h-screen flex items-center justify-center p-5 text-gray-700">

    <div class="bg-white rounded-lg shadow-xl p-8 w-full max-w-lg">
        <h1 class="text-2xl font-bold mb-6 text-center text-bordo-dark">Modificar Cuenta Bancaria</h1>

        <form action="CuentaServlet" method="post">
            <input type="hidden" name="action" value="modificar">
            <input type="hidden" name="cuentaIdModificar" id="cuentaIdModificar" value="CUENTA_ID_EJEMPLO">

            <div class="mb-4">
                <label for="numeroCuentaModificar" class="block text-sm font-medium mb-1">Número de Cuenta:</label>
                <input type="text" id="numeroCuentaModificar" name="numeroCuentaModificar" 
            ...
            <div class="mb-4">
                ...
                <input type="text" id="cbuModificar" name="cbuModificar" 
                       class="block w-full px-3 py-2 rounded-md bg-bordo-light-bg border border-bordo-border 
                              focus:border-bordo-dark focus:ring-3 focus:ring-bordo-dark focus:ring-opacity-20 outline-none
                              placeholder-gray-400 transition duration-200 ease-in-out" 
                       value="1234-5678-90123456">
            </div>

            <div class="mb-4">
                <label for="saldoModificar" class="block text-sm font-medium mb-1">Saldo:</label>
                <input type="number" step="0.01" min="0" id="saldoModificar" name="saldoModificar" 
                       class="block w-full px-3 py-2 rounded-md bg-bordo-light-bg border border-bordo-border 
                              focus:border-bordo-dark focus:ring-3 focus:ring-bordo-dark focus:ring-opacity-20 outline-none
                              placeholder-gray-400 transition duration-200 ease-in-out" 
                       value="15200.50">
            ...
            <div class="mb-4">
                <label for="fechaCreacionModificar" class="block text-sm font-medium mb-1">Fecha de Creación:</label>
                <input type="date" id="fechaCreacionModificar" name="fechaCreacionModificar" 
                       class="block w-full px-3 py-2 rounded-md bg-bordo-light-bg border border-bordo-border 
                              focus:border-bordo-dark focus:ring-3 focus:ring-bordo-dark focus:ring-opacity-20 outline-none
                              placeholder-gray-400 transition duration-200 ease-in-out" 
                       value="2022-01-10">
            ...
            <div class="mb-4">
                <label for="tipoCuentaModificar" class="block text-sm font-medium mb-1">Tipo de Cuenta:</label>
                <select id="tipoCuentaModificar" name="tipoCuentaModificar" 
                        class="block w-full px-3 py-2 rounded-md bg-bordo-light-bg border border-bordo-border 
                               focus:border-bordo-dark focus:ring-3 focus:ring-bordo-dark focus:ring-opacity-20 outline-none
