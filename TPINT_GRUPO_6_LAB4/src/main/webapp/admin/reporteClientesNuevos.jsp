...
<body class="bg-gray-50 p-8">
  ...
  <a href="${pageContext.request.contextPath}/admin/reportes.jsp"
    ...
    ← Volver al Panel de Reportes
		...
		<c:if test="${not empty fechaInicio and not empty fechaFin and empty clientesNuevos}">
 				 <div class="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-4 mt-6 rounded">
   				 <p class="font-semibold">No se encontraron clientes nuevos en el período seleccionado.</p>
			  </div>
			</c:if>
